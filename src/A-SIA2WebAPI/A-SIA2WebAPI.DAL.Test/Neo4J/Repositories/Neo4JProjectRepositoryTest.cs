...
{
    public class Neo4JProjectRepositoryTest
    {
        private Project _entity;
        private Project _entity2;
        private Neo4JEngine _engine;
        private Neo4JProjectRepository _repository;
        ...
        public void SetUp()
        {
            ...
            _repository = new(_engine, new Mock<ILogger<Neo4JProjectRepository>>().Object);
        ...
        public void UpdateTest()
        {
            ...
            Assert.AreEqual(_entity.Name, updated?.Name);
        }
        ...
        public void GetAllTest()
        {
            ...
            Assert.AreEqual(
                ...
                JsonConvert.SerializeObject(
                    entities.Where(e => e.Id == _entity.Id).FirstOrDefault()));
            Assert.AreEqual(
                JsonConvert.SerializeObject(_entity2),
                JsonConvert.SerializeObject(
                    entities.Where(e => e.Id == _entity2.Id).FirstOrDefault()));
        }
